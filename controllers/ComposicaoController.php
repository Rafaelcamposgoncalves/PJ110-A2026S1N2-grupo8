            ...
            switch ($method) {
                ...
                case 'DELETE':
                    ...
                    try {
                        ...
                        // 🔥 CAPTURA ERRO DE REGISTO EM USO (Foreign Key)
                        // Erro 1451 ou SQLSTATE 23000
                        if ($e->getCode() == "23000" || strpos($e->getMessage(), '1451') !== false) {
                            http_response_code(400);
                            echo json_encode([
                                "erro" => "Não é possível excluir este item porque ele já está vinculado a um ou mais pedidos."
                            ]);
                        } else {
                            throw $e; // Repassa outros erros para o catch principal
                        }
                    }
                    break;
